  ...
  def show
  	@user = User.new(:fname => "Robert", 
                     ...
                     :friend_days_a_weeek => "1-2",
                      ...
                      :description => "I recently relocated to San Francisco from Ireland.  Although I am a family man, I really miss my mates back home.  I have tried to find new friends through work, but I really want to find a friendship that doesn't have anything to do with my 9-5.
